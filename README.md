calculate reward point if transaction amount is greater than 100 then added 2 points for every 1$ and if amount is between 50 to 100 then added 1 point for every remaining 1$
